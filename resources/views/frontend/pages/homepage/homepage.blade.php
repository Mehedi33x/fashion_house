    ...
    <div>
        <div class="hero-slider">
            <div class="slider-item th-fullpage hero-area"
                style="background-image: url({{ url('/frontend/assets/images/slider/slider-1.jpg') }});">
                <div class="container">
                    <div class="row">
            ...
            <div class="slider-item th-fullpage hero-area"
                style="background-image: url({{ url('/frontend/assets/images/slider/slider-3.jpg') }});">
                <div class="container">
                    <div class="row">
            ...
            <div class="slider-item th-fullpage hero-area"
                style="background-image: url({{ url('/frontend/assets/images/slider/slider-2.jpg') }});">
                <div class="container">
                    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="category-box">
                        <a href="#!">
                            <img src="{{ url('/frontend/assets/images/shop/category/category-1.jpg') }}" alt="" />
                            <div class="content">
                                <h3>Clothes Sales</h3>
                    ...
                    <div class="category-box">
                        <a href="#!">
                            <img src="{{ url('/frontend/assets/images/shop/category/category-2.jpg') }}" alt="" />
                            <div class="content">
                                <h3>Smart Casuals</h3>
                ...
                <div class="col-md-6">
                    <div class="category-box category-box-2">
                        <a href="#!">
                            <img src="{{ url('/frontend/assets/images/shop/category/category-3.jpg') }}" alt="" />
                            <div class="content">
                                <h3>Jewellery</h3>
            ...
            <div class="row">
                    ...
                    <div class="product-item">
                        <div class="product-thumb">
                            ...
                            <img class="img-responsive"
                                src="{{ url('/frontend/assets/images/shop/products/product-1.jpg') }}" alt="product-img" />
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img class="img-responsive"
                                src="{{ url('/frontend/assets/images/shop/products/product-2.jpg') }}" alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
                                        <span data-toggle="modal" data-target="#product-modal">
